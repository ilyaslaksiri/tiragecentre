...
$requete3="SELECT max(`ID_DEVIS`) num FROM `devis`";
...
<form  action="ajouter_devis_exec.php" method="post">
<h4 class="titre_info">Client : <?php echo $ligne['NOM_CLIENT'];?></h4>
 
 <?php $num_devis= 101+$ligne3["num"]."/".date("y"); ?>
...
<table  width="90%" >
	<tr>			
			<td align="right" >  Devis N&deg;  		&nbsp;:</td><td width="55%"><?php echo $num_devis; ?> </td>
			<td align="right"> Date 	<span style="color:#FF0000">(*)</span>&nbsp;:</td> <td> <input type="text" name="date_devis" value="<?php echo date("d/m/Y");?>" class="required" />  </td>
	</tr>
