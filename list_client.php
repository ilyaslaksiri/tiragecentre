...
$requete4 = mysql_query("SELECT count(`ID_FACTURE`) nb FROM `FACTURE` WHERE `ID_CLIENT`=".$ligne["ID_CLIENT"]." and `ID_EXERCICE`=".$_SESSION["annee"]);
$ligne4 = mysql_fetch_array($requete4);
   ...
   print "<tr>
		...
		<td align=center><a href=list_facture.php?id_client=$ligne[ID_CLIENT] title=Consulter>($ligne4[nb])</a></td>
