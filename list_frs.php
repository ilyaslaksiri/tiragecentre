...
<h4 class="titre_info">Liste des Fournisseurs</h4><br/><br/>
...
$requete4 = mysql_query("SELECT count(`ID_FACTURE_FRS`) nb FROM `facture_frs` WHERE `ID_FRS`=".$ligne["ID_FRS"]);
...
$ligne4 = mysql_fetch_array($requete4);
   ...
   print "<tr>
		...
		<td align=center><a href=list_facture_frs.php?id_frs=$ligne[ID_FRS] title=Consulter>($ligne4[nb])</a></td>
