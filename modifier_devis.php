...
$requete2="select * from devis where ID_DEVIS=$id_devis";
...
<form  action="modifier_devis_exec.php" method="post">

<input type="hidden" name="id_client" value="<?php echo $ligne['ID_CLIENT'];?>" />
<h4 class="titre_info">Client : <?php echo $ligne['NOM_CLIENT'];?></h4>
 
<input type="hidden" name="id_devis" value="<?php echo $ligne2['ID_DEVIS']; ?>" />
 
 <fieldset>
 
<table  width="90%" >
	<tr>			
			<td align="right"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Devis N&deg; 		&nbsp;:</td><td>  <?php echo $ligne2['NUM_DEVIS'];?></td>
			<td align="right" > Date 	<span style="color:#FF0000">(*)</span>&nbsp;:</td> <td> <input type="text" name="date_devis" value="<?php echo $ligne2['DATE_DEVIS'];?>" class="required" />  </td>
	</tr>
	<tr>			
			<td align="right" width="26%">Utiliser ce devis pour le calcule des factures </td>
			<td width="37%"> 	
					<input type="radio" name="calcule" value="OUI" <?php if($ligne2["CALCULE"]=="OUI")echo "checked"; ?>> oui
					<input type="radio" name="calcule" value="NON" <?php if($ligne2["CALCULE"]=="NON")echo "checked"; ?>> non
			</td>
...
<div id="Total">
		...
		<tr><td>Arreter le pr&eacute;sent devis a la somme de : </td></tr>
