...
<body>
	...
	<header id="header">
		<hgroup>
			...
			<h2 class="section_title"><a href="notification.php"><img src="images/notif.png" width="50px"></a></h2>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs">
				...
				<a  href="instant_redirect.php?annee=2014&&url=<?php echo $page; ?>" class="current" title="Changer l'exercice" >
				<input type="radio"  <?php if( $_SESSION["annee"]==2014) echo "checked"?>  >2014
				</a>
				<a  href="instant_redirect.php?annee=2015&&url=<?php echo $page; ?>" class="current" title="Changer l'exercice" >
				<input type="radio"  <?php if($_SESSION["annee"]==2015) echo "checked"?>  >2015
				</a>
				<a  href="instant_redirect.php?annee=2016&&url=<?php echo $page; ?>" class="current" title="Changer l'exercice" >
				<input type="radio"  <?php if($_SESSION["annee"]==2016) echo "checked"?>  >2016
				</a>
