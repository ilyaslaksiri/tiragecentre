	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sZeroRecords": "Aucun enregistrement correspondant a votre recherche",
				"sEmptyTable": "Pas de donn&eacute;es disponibles&nbsp;dans le tableau",
				"sLoadingRecords": "Chargement...",
				"sInfo": "Enregistrements de _START_ &agrave; _END_ Du total _TOTAL_ ",
				"sInfoEmpty": "",
				"sInfoFiltered": "",
				"sInfoPostFix": "",
				"sInfoThousands": ",",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" class="quick_search_t "/>') :
			  sSearchStr==="" ? '<input type="text" class="quick_search_t"' : sSearchStr+' <input type="text" class="quick_search_t"  />';
