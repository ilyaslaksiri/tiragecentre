...
<style type="text/css" title="currentStyle">
		...
		<div align="center">
		  <?php echo "<a href=ajouter_bc.php?id_frs=$id_frs>Nouveau Bon de Commande</a>";?>
		</div>
...
$requete2 = mysql_query("select * from bc where ID_FRS=$id_frs and ID_EXERCICE=".$_SESSION["annee"] );
while ($ligne = mysql_fetch_array($requete2)) {

   print "<tr>
  
		<td align=center>".$ligne["NUM_BC"]."</td>
		<td align=center>".$ligne["DATE_BC"]."</td>
		<td align=center>".$ligne["MONTANT_HT"]."</td>
		<td align=center>".$ligne["MONTANT_TTC"]."</td>
		
	
		
		<td align=center><a href=modifier_bc.php?id_bc=$ligne[ID_BC] title=Modifier><img src=images/icn_edit.png></a></td>
		";
	
	 if("$_SESSION[user]"== "admin"){
		print "
		
		<td align=center><a href=# OnClick=\"window.open('imprimer_bc.php?id_bc=$ligne[ID_BC]','width=400','height=630','left=20','top=30');\"  title=Voir><img src=images/pdf.gif /></a></td>
		";}
